      ...
      <BrowserRouter>
        <div>
          ...
          <Switch>
              ...
              <SecuredRoute path='/admin' component={Admin} editId={this.state.editId} onEdit={this.state.onEdit} handleFormInput={this.handleFormInput} handleFormSubmit={this.handleFormSubmit} handleOverlayExit={this.handleOverlayExit} handleToProductAdmin={this.handleToProductAdmin} handleToContactAdmin={this.handleToContactAdmin} handleOverlay={this.handleOverlay} handleEditProduct={this.handleEditProduct} handleDeleteProduct={this.handleDeleteProduct} contactinfos={this.state.contactinfos} cakeFull={this.state.cakeFull} 
